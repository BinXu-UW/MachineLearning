...
dataDir='D:/python/'
file_name_user_rating = dataDir + 'result1.txt'
output_file = dataDir + 'result2.txt'
...
for line in fIn:
    ...
    allRating_vec[ii, 2] = 2*float(track_rating) + 2*float(album_rating) + 0.05*sum(artist_rating)+0.1*sum(genre_rating)# get the mean rating of genre
